...
HD_PWD='/home/zhoulian/work/hxzy/cy/gen2/bypass/boards/690t/bypass_690t/bypass_690t.runs/impl_1157'
cd "$HD_PWD"
...
EAStep vivado -log bypass_690t.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bypass_690t.tcl -notrace
