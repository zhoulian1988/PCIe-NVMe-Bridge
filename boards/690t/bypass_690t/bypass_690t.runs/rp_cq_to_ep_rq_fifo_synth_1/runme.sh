...
HD_PWD='/home/zhoulian/work/hxzy/cy/gen2/bypass/boards/690t/bypass_690t/bypass_690t.runs/rp_cq_to_ep_rq_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_cq_to_ep_rq_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rp_cq_to_ep_rq_fifo.tcl
