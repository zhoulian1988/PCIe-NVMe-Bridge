...
HD_PWD='/home/zhoulian/work/hxzy/cy/gen2/bypass/boards/690t/bypass_690t/bypass_690t.runs/rp_690t_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rp_690t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rp_690t.tcl
