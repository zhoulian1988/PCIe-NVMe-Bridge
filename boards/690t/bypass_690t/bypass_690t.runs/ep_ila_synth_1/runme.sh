...
HD_PWD='/home/zhoulian/work/hxzy/cy/gen2/bypass/boards/690t/bypass_690t/bypass_690t.runs/ep_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ep_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ep_ila.tcl
