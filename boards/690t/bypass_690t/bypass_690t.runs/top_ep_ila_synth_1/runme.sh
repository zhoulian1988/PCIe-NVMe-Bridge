...
HD_PWD='/home/zhoulian/work/hxzy/cy/gen2/bypass/boards/690t/bypass_690t/bypass_690t.runs/top_ep_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ep_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ep_ila.tcl
