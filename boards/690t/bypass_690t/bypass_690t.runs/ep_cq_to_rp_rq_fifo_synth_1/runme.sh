...
HD_PWD='/home/zhoulian/work/hxzy/cy/gen2/bypass/boards/690t/bypass_690t/bypass_690t.runs/ep_cq_to_rp_rq_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ep_cq_to_rp_rq_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ep_cq_to_rp_rq_fifo.tcl
